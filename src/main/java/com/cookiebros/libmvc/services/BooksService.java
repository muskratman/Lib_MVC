...
public class BooksService {
    ...
    public Book findOne(String title, String author, int yearOfPublishing) {
        return booksRepository.findByTitleAndAuthorAndYearOfPublishing(title, author, yearOfPublishing).orElse(null);
    }
